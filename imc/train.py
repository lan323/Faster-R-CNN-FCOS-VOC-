import sys
sys.path.append(r"C:\Users\admin\PycharmProjects\pythonProject3\imc")
...
def train_mixup(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(progress_bar):
        ...
        inputs, targets_a, targets_b, lam = mixup_data(inputs, targets, args.alpha, False)
...
train_transform,test_transform = train_test_transform()
...
optimizer = torch.optim.SGD(model.parameters(), lr=args.learning_rate,momentum=0.9, nesterov=True, weight_decay=5e-4)
...
if not args.data_augmentation:
    test_id += '_noaugment'
filename = 'C:/Users/admin/PycharmProjects/pythonProject3/imc/csv/' + test_id + '.csv'
csv_logger = CSVLogger(args=args, fieldnames=['epoch', 'train_loss', 'train_acc', 'test_loss', 'test_acc'],filename=filename)
tb = SummaryWriter('C:/Users/admin/PycharmProjects/pythonProject3/imc/csv/folder')
...
torch.save(model.state_dict(), 'C:/Users/admin/PycharmProjects/pythonProject3/imc/' + test_id + '.pt')
csv_logger.close()
